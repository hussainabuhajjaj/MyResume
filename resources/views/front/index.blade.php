...
@include('front.layouts.head')
  ...
  <body>
    <!-- Animated Background -->
    <div class="lm-animated-bg" style="background-image: url({{asset('frontassets/img/main_bg.png')}});"></div>
    <!-- /Animated Background -->
          ...
          <header id="site_header" class="header mobile-menu-hide">
            <div class="header-content">
              <div class="header-photo">
                <img src="{{asset('frontassets/img/main_photo.jpg')}}" alt="Alex Smith">
              </div>
              <div class="header-titles">
                <h2>Hussain Abu Hajjaj</h2>
                <h4>Web Designer</h4>
              </div>
            </div>
                      ...
                      <div class="info-list">
                        <ul>
                          ...
                          <li>
                            ...
                            <span class="value"><a href="https://lmpixels.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c0a5ada1a9ac80a5b8a1adb0aca5eea3afad">[email&#160;protected]</a></span>
                          </li>
                    ...
                    <div class="col-xs-12 col-sm-12">
                      <div class="testimonials owl-carousel">
                        ...
                        <div class="testimonial">
                          <div class="img">
                            <img src="{{asset('frontassets/img/testimonials/testimonial-1.jpg')}}" alt="Alex Smith">
                          </div>
                          <div class="text">
                        ...
                        <div class="testimonial">
                          <div class="img">
                            <img src="{{asset('frontassets/img/testimonials/testimonial-2.jpg')}}" alt="Alex Smith">
                          </div>
                          <div class="text">
                            <p>Vivamus at molestie dui, eu ornare orci. Curabitur vel egestas dolor. Nulla condimentum nunc sit amet urna tempus finibus. Duis mollis leo id ligula pellentesque, at vehicula dui ultrices.</p>
                          </div>
                        ...
                        <div class="testimonial">
                          <div class="img">
                            <img src="{{asset('frontassets/img/testimonials/testimonial-3.jpg')}}" alt="Alex Smith">
                          </div>
                          <div class="text">
                            <p>Vivamus at molestie dui, eu ornare orci. Curabitur vel egestas dolor. Nulla condimentum nunc sit amet urna tempus finibus. Duis mollis leo id ligula pellentesque, at vehicula dui ultrices.</p>
                          </div>
                      ...
                      <div class="clients owl-carousel">
                        ...
                        <div class="client-block">
                          <a href="#" target="_blank" title="Logo">
                            <img src="{{asset('frontassets/img/clients/client-4.png')}}" alt="Logo">
                          </a>
                        </div>

                        <div class="client-block">
                          <a href="#" target="_blank" title="Logo">
                            <img src="{{asset('frontassets/img/clients/client-5.png')}}" alt="Logo">
                          </a>
                        </div>

                        <div class="client-block">
                          <a href="#" target="_blank" title="Logo">
                            <img src="{{asset('frontassets/img/clients/client-6.png')}}" alt="Logo">
                          </a>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-6">
                      <div class="certificate-item clearfix">
                        <div class="certi-logo">
                          <img src="{{asset('frontassets/img/clients/client-1.png')}}" alt="logo">
                        </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-4">
                      ...
                      <div class="lm-info-block gray-default">
                        ...
                        <h4><a href="https://lmpixels.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d9b8b5bca199bca1b8b4a9b5bcf7bab6b4">[email&#160;protected]</a></h4>
                        <span class="lm-info-block-value"></span>
                        <span class="lm-info-block-text"></span>
                      </div>
                    ...
                    <div class="col-xs-12 col-sm-8">
                      ...
                      <form id="contact_form" class="contact-form" action="https://lmpixels.com/demo/breezycv/light/2/contact_form/contact_form.php" method="post">
